...
scheduler.add_job(main_difference_latter, 'cron', hour="0, 1, 4", minute="40", day_of_week="mon, wed, thu, sat, sun")
scheduler.add_job(main_difference_latter, 'cron', hour="7-23", minute="40", day_of_week="mon, wed, thu, sat, sun")
scheduler.add_job(main_difference_latter, 'cron', hour="0, 1", minute="40", day_of_week="tue, fri")
scheduler.add_job(main_difference_latter, 'cron', hour="9-23", minute="40", day_of_week="tue, fri")
